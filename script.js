...
document.getElementById('siBtn').addEventListener('click', function() {
    ...
    document.getElementById('messageContainer').innerHTML = '¡Oh Siii! Te Amo Muchooo Mi Abigail, Mi vida ';
...
document.getElementById('noBtn').addEventListener('click', function() {
    switch (noButtonState) {
        ...
        case 2:
            ...
            document.getElementById('noBtn').innerHTML = 'Estás seguro de verdad, Abigail';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
            document.getElementById('sadGifContainer').style.display = 'none';
            document.getElementById('sadGifContainer2').style.display = 'none';
...
const numberOfSnowflakes = 500; // Aumentamos la cantidad de copos

for (let i = 0; i < numberOfSnowflakes; i++) {
    const snowflake = document.createElement('div');
    snowflake.textContent = '❄';  // Usamos el símbolo de copo de nieve
